...
public class SolrConnector extends SqoopConnector {

  private static final To TO = new To(
          SolrToInitializer.class,
          SolrLoader.class,
          SolrToDestroyer.class);
  ...
  public ResourceBundle getBundle(Locale locale) {
    return ResourceBundle.getBundle(SolrConstants.RESOURCE_BUNDLE_NAME, locale);
  }
