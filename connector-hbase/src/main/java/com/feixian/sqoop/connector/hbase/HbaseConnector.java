...
public class HbaseConnector extends SqoopConnector {

  private static final To TO = new To(
          HbaseToInitializer.class,
          HbaseLoader.class,
          HbaseToDestroyer.class);
  ...
  public ResourceBundle getBundle(Locale locale) {
    return ResourceBundle.getBundle(HbaseConstants.RESOURCE_BUNDLE_NAME, locale);
  }
